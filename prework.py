...
# In Python, you can use any combination of upper and lower case letters to make a variable name. Most special characters aren’t allowed, but there are a few exceptions. If you run the code below, it will crash due to invalid variable names. Find the invalid variable names and delete the special characters (be sure to leave the special characters in the valid variable names alone).
# bob7 = 50
# bob = 50
# bobat = 50
# atbob = 50
